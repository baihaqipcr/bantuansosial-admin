                        ...
                        <form action="{{ route('pelanggan.store') }}" method="POST">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    <!-- First Name -->
                                    <div class="mb-3">
                                        <label for="nama_awal_penerima" class="form-label">First name</label>
                                        <input type="text" name="nama_awal_penerima" id="nama_awal_penerima" class="form-control" required>
                                    </div>

                                    <!-- Last Name -->
                                    <div class="mb-3">
                                        <label for="nama_akhir_penerima" class="form-label">Last name</label>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <!-- Birthday -->
                                    <div class="mb-3">
                                        <label for="tgl_lahir" class="form-label">Birthday</label>
