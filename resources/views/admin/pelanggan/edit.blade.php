                        ...
                        <form action="{{ route('pelanggan.update', $dataPelanggan->pelanggan_id) }}" method="POST">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    <!-- First Name -->
                                    <div class="mb-3">
                                        <label for="nama_awal_pelanggan" class="form-label">Nama Awal</label>
                                        <input type="text" name="nama_awal_pelanggan" id="nama_awal_pelanggan" class="form-control"
                                        value="{{ $dataPelanggan->nama_awal_pelanggan}}" required>
                                    </div>

                                    <!-- Last Name -->
                                    <div class="mb-3">
                                        <label for="nama_akhir_pelanggan" class="form-label">Nama Terakhir</label>
                                        <input type="text" name="nama_akhir_pelanggan" id="nama_akhir_pelanggan" class="form-control"
                                        value="{{ $dataPelanggan->nama_akhir_pelanggan }}">
                                    </div>
                                </div>
