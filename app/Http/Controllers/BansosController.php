...
class BansosController extends Controller
{
    ...
    public function index()
    {
        $dataBansos = [
            ...
            ['penerima' => 'Kaye', 'jenisBantuan' => 'Mie Instan', 'jumlahBantuan' => '1 kardus', 'status' => 'sedang diproses'],
            ['penerima' => 'Arsyad', 'jenisBantuan' => 'Minyak Goreng', 'jumlahBantuan' => '2 liter', 'status' => 'belum diterima'],
